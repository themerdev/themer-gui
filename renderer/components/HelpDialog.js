...
const HelpDialog = ({ closeDialogs }) => (
  <div className={ css.help }>
    ...
    <p>Your theme can define a dark color set, a light color set, or both. Here is how the colors are typically used in outputted themes:</p>
    ...
    <p>
      <Emoji emoji="💡" right />
      <strong>accent0-7 should be the main accent colors of your theme. shade0-7 should be shades of a similar hue.</strong>
    </p>
